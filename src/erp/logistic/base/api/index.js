...
import axios3 from 'api/MSAApi'; // 'http://localhost:9102
...
export const saveDetailCodeInfo = (action) =>
    axios.post('/base/batchDetailListProcess', {
...
export const saveClient = (action) => axios3.post('/compinfo/customer/batch', { batchList: action.payload });
...
export const saveFinanInfo = (action) => axios3.post('/compinfo/financialaccountassociates/batch', { batchList: action.payload });
