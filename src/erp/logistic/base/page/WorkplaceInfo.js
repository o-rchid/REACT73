...
import { Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, Button, Grid, Checkbox } from '@mui/material';
        ...
        <>
            ...
            >
                                ...
                                return (
                                    ...
                                    >
                                        {columns.map((column) => {
                                            ...
                                            return (
                                                <TableCell id={labelId} key={column.id} align={column.align}>
                ...
                <SimpleModal open={addOpenDialog} close={close} title={'사업장 추가'}>
                    <div>
                        <AddWorkplace onSubmit={onSubmit} close={close} />
                    </div>
                </SimpleModal>
